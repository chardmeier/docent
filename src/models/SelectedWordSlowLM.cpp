	...
	public FeatureFunction::StateModifications
{
	...
	virtual SelectedWordSlowLMState
	*clone()
	const {
...
*SelectedWordSlowLM<M>::initDocument(
	const DocumentState &doc,
	Scores::iterator sbegin
) const {
...
template<class M>
void SelectedWordSlowLM<M>::computeSentenceScores(
	const DocumentState &doc,
	uint sentno,
	Scores::iterator sbegin
) const {
...
template<class M>
FeatureFunction::StateModifications
*SelectedWordSlowLM<M>::updateScore(
	const DocumentState &doc,
	const SearchStep &step,
	const State *state,
...
template<class M>
FeatureFunction::State
*SelectedWordSlowLM<M>::applyStateModifications(
	FeatureFunction::State *oldState,
	FeatureFunction::StateModifications *modif
) const {
