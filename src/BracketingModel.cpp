...
BracketingModel::BracketingModel(
...
void BracketingModel::computeSentenceScores(
	const DocumentState &doc,
	uint sentno,
	Scores::iterator sbegin
) const {
...
*BracketingModel::estimateScoreUpdate(
	const DocumentState &doc,
...
FeatureFunction::State
*BracketingModel::applyStateModifications(
