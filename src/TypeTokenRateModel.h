...
#ifndef docent_TypeTokenRateModel_h
#define docent_TypeTokenRateModel_h

class TypeTokenRateModel : public FeatureFunction {
public:
	TypeTokenRateModel(const Parameters &params) {}
