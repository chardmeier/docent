...
#ifndef docent_SentenceFinalWordModel_h
#define docent_SentenceFinalWordModel_h

class SentenceFinalWordModel : public FeatureFunction {
public:
	SentenceFinalWordModel(const Parameters &params) {}
