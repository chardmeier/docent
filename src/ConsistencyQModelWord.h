...
#ifndef docent_ConsistencyQModelWord_h
#define docent_ConsistencyQModelWord_h




class ConsistencyQModelWord : public FeatureFunction {
public:
	ConsistencyQModelWord(const Parameters &params) {}
