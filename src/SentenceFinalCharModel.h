...
#ifndef docent_SentenceFinalCharModel_h
#define docent_SentenceFinalCharModel_h

class SentenceFinalCharModel : public FeatureFunction {
public:
	SentenceFinalCharModel(const Parameters &params) {}
